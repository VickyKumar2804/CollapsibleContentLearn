<div class="collapsible-content--container teaser" itemscope itemtype="http://schema.org/BlogPosting">
    <div class="collapsible-content--visible" itemprop="headline">
		<span class="<?php echo $attributes['show_icon']; ?> collapsible-content--icon" aria-hidden="true"
            ...
            <span class="screen-reader-text">Click to reveal the answer</span></span><?php esc_html_e( $attributes['visible_message'] ); ?>
    </div>
    <div class="collapsible-content--hidden" itemprop="description"
